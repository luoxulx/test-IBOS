    ...
    <div class="header" id="header">
        <div class="wrap">
                    ...
                    <?php foreach ($navs as $index => $nav): ?>
                        ...
                        <?php if ($nav['module'] == 'crm'): ?>
                            <ul class="subnv" id="sub_nav_<?php echo $index; ?>" data-pid="<?php echo $index; ?>">
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/lead/index')?>">线索</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/client/index')?>">客户</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/contact/index')?>">联系人</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/opportunity/index')?>">商机</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/event/index')?>">跟进</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/contract/index')?>">合同</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/receipt/index')?>">收款</a></li>
                                <li><a target="_self" href="<?php echo Ibos::app()->urlManager->createUrl('crm/highseas/index')?>">管理</a></li>
                            </ul>
                        <?php endif;?>
            ...
            <div class="usi">
                ...
                <a href="<?php echo Ibos::app()->createUrl('message/notify/index'); ?>" class="cbtn o-message"
                   id="user_fun_ctrl" title="消息中心">
        ...
        <div class="uil-card" id="user_login_card" style="display:none;">
            ...
            <div class="uil-card-body">
                ...
                <div class="progress" title="Progress-bar">
                    <div class="progress-bar <?php if (Ibos::app()->user->upgrade_percent > 90): ?>progress-bar-danger<?php else: ?>progress-bar-success<?php endif; ?>"
                            style="width: <?php echo Ibos::app()->user->upgrade_percent; ?>%;">
                    </div>
                </div>
                <div class="btn-group btn-group-justified">
                    <a href="<?php echo Ibos::app()->urlManager->createUrl('user/home/personal', array('op' => 'profile', 'uid' => Ibos::app()->user->uid)); ?>" class="btn"><i class="om-user"></i>个人</a>
